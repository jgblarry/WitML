...
aws s3 cp s3://witadvisor-config/prod/admin-wit.conf /etc/nginx/conf.d/wit.conf
sed -i 's/APPLICATION/admin/g' "/etc/nginx/conf.d/wit.conf"
...
sed -i 's/APPLICATION/admin/g' "/var/awslogs/etc/awslogs.conf"
