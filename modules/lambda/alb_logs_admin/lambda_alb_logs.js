...
exports.handler = (event, context, callback) => {
   // Configuration LogsStream
   function basename(path) {
    return path.split('/')[0];
   }
   //const logGroupName = basename(event.Records[0].s3.object.key);
   const logGroupName = 'ALB_WITADVISOR_PROD';
   const logStreamName = 'ALB_LOGS_ADMIN';
